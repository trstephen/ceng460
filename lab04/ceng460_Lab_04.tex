...
\addbibresource{CENG460_Lab_04.bib}

%----------------------------------------------------------------------------
%		     MACROS AND COMMANDS
%----------------------------------------------------------------------------

% a counter that resets whenever the subsection is incremented
\newcounter{questions}[subsection]

\newenvironment{Question}
	{
		\itshape % all text in env is italic
		\refstepcounter{questions} % incr counter (resets to 0)
		\thequestions.\@ % display counter, then sentence spacing
	}
	{
		% no behavior
	}
...
\newcommand{\ackarrow}{\ensuremath{\xrightarrow{ACK}}}
